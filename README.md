...
2. **Network Assembly**: INDRA, PyBEL, Pathway Commons.
3. **AI/LLM**: Cleanlab Studio API (Trustworthy Language Model), OpenAI GPT-4.
4. **Data Analysis**: Python (Pandas, NumPy, Matplotlib), Otsu’s Method implementation
